...
var testInstance = new testView({
	...
	template: '<div class="task" data-id="{id}"><div class="floatRight"><a href="#" class="task-remove">x empty</a></div><div class="task-title">{title}</div><div class="task-body">{task}</div><div class="clear"></div></div>',
